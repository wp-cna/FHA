...
(function () {
  var ES = {
    ...
    "Dues": "Cuotas",
    "Annual dues are $5 for an individual or $10 for a family. Submit the request below; after a board member verifies your Fisher Hill connection, the Association will email the current payment instructions.": "Las cuotas anuales son de $5 por persona o $10 por familia. Envíe la solicitud a continuación; después de que un miembro de la directiva verifique su vínculo con Fisher Hill, la Asociación le enviará por correo electrónico las instrucciones de pago vigentes.",
    "Payment follow-up": "Seguimiento del pago",
    "Submit the membership request below. After a board member verifies your Fisher Hill connection, the Association will email the current payment options and instructions. No payment is collected on this website.": "Envíe la solicitud de membresía a continuación. Después de que un miembro de la directiva verifique su vínculo con Fisher Hill, la Asociación le enviará por correo electrónico las opciones e instrucciones de pago vigentes. No se cobra ningún pago en este sitio web.",
    "Name": "Nombre",
    ...
    "Public contact (optional — published on your post)": "Contacto público (opcional — se publica en su anuncio)",
    "Phone number, email address, or secure website URL. Leave blank if you do not want contact details shown on your post.": "Número de teléfono, correo electrónico o URL segura de un sitio web. Déjelo en blanco si no desea mostrar datos de contacto en su anuncio.",
